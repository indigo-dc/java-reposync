...
public class RepositoryServiceProviderServiceImplTest {
  ...
  public void setUp() throws Exception {
    ...
    RepositoryServiceProviderServiceImpl svc =
      new RepositoryServiceProviderServiceImpl(provider,mockClient);
