...
To extend or develop new functionalities, see the [development guide](development.md)
...
Once installed, it should be configured as described in the Configuration section
